...
public:
	...
	afx_msg void OnHistogramCompute();
	afx_msg void OnHistogramDraw();
	afx_msg void OnHistogramCumulatecompute();
	afx_msg void OnHistogramCumulatedraw();
	afx_msg void OnHistogramBin();
	afx_msg void OnHistogramEqualize();
	afx_msg void OnHistogramMatch();
	bool histMatch_Value(Mat matSrc, Mat matDst, Mat& matRet);
	afx_msg void OnHistogramStep();
	afx_msg void OnHistogramGaussian();
	afx_msg void OnSmoothMean();
	afx_msg void OnSmoothGaussian();
	void MinFilter(Mat& src_image, Mat& dst_image, int k_size);
	afx_msg void OnSmoothMin();
	afx_msg void OnSmoothMax();
	void MaxFilter(Mat& src_image, Mat& dst_image, int k_size);
	afx_msg void OnSmoothMiddle();
	afx_msg void OnSmoothMedian();
	void TrimmedMean(Mat img_input, Mat& img_output, int m, int n, int d);
	afx_msg void OnSmoothTrimmed();
};
